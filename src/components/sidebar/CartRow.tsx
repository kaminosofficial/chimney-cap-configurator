...
export function CartRow({ onAddToCart, onBuyNow, onExportPdf, isSubmitting = false, submittingAction = null, submittingStep = '' }: Props) {
  ...
  return (
    <>
      {/* Export PDF — full-width button above cart actions */}
      {onExportPdf && (
        <button
          id="export-pdf-btn"
