...
//
// Flow:  open → capture snapshot (spinner) → show preview → Download PDF
// ─────────────────────────────────────────────────────────────────────────────
...
export function PdfPreviewModal({ open, onClose, captureSnapshot }: PdfPreviewModalProps) {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      await generatePdf('print-mount', `KAMINOS-ChimneyCap-${dateStr}.pdf`);
    } finally {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            {/* PDF icon */}
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#c9a870" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <div style={{
          ...
          {isCapturing ? (
            ...
            <div style={{
              ...
              /* Compensate for the scale-down so the scrollable area height is correct */
              marginBottom: 'calc((0.82 - 1) * 100%)',
            }}>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              background: isDownloading || isCapturing ? '#cdbca2' : 'rgb(209, 179, 130)',
            ...
            onMouseEnter={e => { if (!isDownloading && !isCapturing) (e.currentTarget as HTMLButtonElement).style.background = '#c5a575'; }}
            onMouseLeave={e => { if (!isDownloading && !isCapturing) (e.currentTarget as HTMLButtonElement).style.background = 'rgb(209, 179, 130)'; }}
          >
            {/* Download icon */}
            {!isDownloading && (
